...
<input
                ...
                <div className="grid place-items-center sm:col-span-2 gap-5 mb-5 w-full">
                    ...
                    <button className=' rounded-rsm border border-white hover:border-red text-dark bg-white hover:bg-red hover:text-white transition px-10 py-4 text-sm  font-bold w-fit cursor-pointer' onClick={()=>handleSignUpWithPop()}>Sign Up With Google</button>
