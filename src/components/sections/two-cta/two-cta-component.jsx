	...
	const ctaDetails = [
		{
			...
			subheading: "A pint of blood can be a lifeline for someone in need",
			heading: "Donate at Bloodirect",
		...
		},
		{
			...
			subheading: "Lives on Hold: Blood Shortage Creates Emergency Need",
			heading: "Request Now",
